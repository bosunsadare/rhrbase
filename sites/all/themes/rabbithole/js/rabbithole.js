	...
	Drupal.behaviors.rabbithole = {
		attach: function (context, settings) {
			...
			$(document).ready(function() {
				...
				$('nav#site-navigation ul.sf-menu').superfish({
					popUpSelector: 'ul.sub-menu,.sf-mega', 	// within menu context
					delay: 400,                	// one second delay on mouseout
					speed: 200,               		// faster animation speed
					speedOut: 200,             		// speed of the closing animation
					animation: {opacity: 'show'},		// animation out
					animationOut: {opacity: 'hide'},		// animation in
					cssArrows: true,              		// set to false
					autoArrows: true                    // disable generation of arrow mark-up
				});


				$('#footer-menu-progression ul.sf-menu').superfish({
					popUpSelector: 'ul.sub-menu,.sf-mega', 	// within menu context
					delay: 400,                	// one second delay on mouseout
					speed: 200,               		// faster animation speed
					speedOut: 200,             		// speed of the closing animation
				...
				/*
				 =============================================== 08. Backstretch ===============================================
				 */
				var filename = Drupal.settings.rabbithole.filename;

				$("body.not-front #soundbyte-page-title, body.node-type-page #soundbyte-page-title, body.episodes #soundbyte-page-title, body.page-contact #soundbyte-page-title, body.node-type-blog #soundbyte-page-title, body.node-type-episode #soundbyte-page-title, body.node-type-article #soundbyte-page-title").backstretch([filename], {
					fade: 750,
					centeredY: true
				});
